                        ...
                        <div class="row">
                            <div class="col-md-6 col-sm-6 col-xs-12">
                                <div class="event-timeline">
                                    ...
                                    <ul>
                                        <li><i class="fa fa-clock-o"></i><b>Event Time:  {{ $project->start_date }}</b>on {{ $project->volunteering_hours_start}} <br>to {{ $project->start_date}}<br> on {{ $project->volunteering_hours_end}}  </li>
